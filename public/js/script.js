...
window.onload = function () {
    ...
    bingImageSearch("site:giphy.com/", "mkt=en-US&SafeSearch=strict&freshness=year&count=20&offset=0", "subscription_key"); 
}
...
//An object containing render functions for 2 types of search results: Query search and related search
searchItemRenderers = { 
...
function quickSearch(query) {
    //Gets <form> with name 'bing'
    var bing = document.forms.bing;
    //Appends the search term to the searchbox (name=query)
    bing.query.value = query;

    //document.getElementById("enterbutton").click();
    //document.getElementById("bing").submit();
    //return bing;
    //document.getElementById("term").event.keyCode === 13
